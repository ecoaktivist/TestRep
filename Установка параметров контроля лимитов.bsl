...
&НаСервере
Процедура МодификацияФормы()
	
	ЭлементФормы = Элементы.Добавить("ТипыДоговора", Тип("ПолеФормы"), ЭтотОбъект);
	ЭлементФормы.Вид = ВидПоляФормы.ПолеВвода;
	ЭлементФормы.ПутьКДанным = "Объект.ТипыДоговора";
	ЭлементФормы.ОтображатьФлажкиВВыпадающемСпискеПриВводеМножественныхЗначений = Истина;
	ЭлементФормы.ПутьКДаннымЗначенияМножественногоЗначения = "Объект.ТипыДоговора.ТипДоговора";
	Элементы.Переместить(ЭлементФормы, Элементы.ГруппаЛевая);
	
	ЭлементФормы = Элементы.Добавить("СтатусыДоговора", Тип("ПолеФормы"), ЭтотОбъект);
	ЭлементФормы.Вид = ВидПоляФормы.ПолеВвода;
	ЭлементФормы.ПутьКДанным = "Объект.СтатусыДоговора";
	ЭлементФормы.ОтображатьФлажкиВВыпадающемСпискеПриВводеМножественныхЗначений = Истина;
	ЭлементФормы.ПутьКДаннымЗначенияМножественногоЗначения = "Объект.СтатусыДоговора.СтатусДоговора";
	Элементы.Переместить(ЭлементФормы, Элементы.ГруппаЛевая);
